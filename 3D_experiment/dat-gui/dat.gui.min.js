         ...
         , f = {
             ...
             , addClass: function (a, d) {
                 if (void 0 === a.className) a.className = d;
                     ...
                     var b = a.className.split(/ +/); - 1 == b.indexOf(d) && (b.push(d), a.className = b.join(" ")
                         .replace(/^\s+/, "")
                         .replace(/\s+$/, ""))
                 }
                 return f
 ...
 dat.GUI = dat.gui.GUI = function (e, a, b, d, f, c, p, k, l, q, n, r, y, g, h) {
     ...
     function s(a, d, b) {
         ...
         b.setValue = h.compose(function (d) {
             a.getRoot()
                 .__preset_select && b.isModified() && D(a.getRoot(), !0);
             return d
         }, b.setValue)
     }
     ...
     h.extend(m.prototype, {
         ...
         , revert: function (a) {
             h.each(this.__controllers, function (b) {
                 this.getRoot()
                     .load.remembered ? v(a || this.getRoot(), b) : b.setValue(b.initialValue)
             }, this);
         ...
         var k = function (e, n) {
             ...
             a.bind(this.__selector, "mousedown", function (b) {
                 a.addClass(this, "drag")
                     .bind(window, "mouseup", function (b) {
